...
public class Tests implements Runnable {
    ...
    public String testCourseStat(){
        ...
        boolean courseNameBool = courseName.equals("Course: ("+p.getCourseNum()+") "+p.getCourseName());
        boolean seatsAvlBool = seats.equals("Seats Available: "+ "0/"+numOfThreads);
        if (!ack.equals("ACK 7")||!courseNameBool
                ||!seatsAvlBool||!studentsL.equals(students))
